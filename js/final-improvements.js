...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    style.textContent = `
      ...
      .communication-modal .secure-code-backdrop{background:rgba(10,20,30,.22)}
      ...
      .signup-modal{align-items:flex-start!important;justify-content:center!important;padding:36px 14px 18px;box-sizing:border-box;overflow:auto}
      .signup-card{width:min(980px,calc(100vw - 28px));max-height:calc(100vh - 56px);overflow:auto;padding:18px 20px!important}
      ...
      .signup-grid input,.signup-grid select{border:1px solid #b8c7d9;border-radius:6px;padding:9px 10px!important;font-size:13px!important;line-height:1.25!important;letter-spacing:0!important;text-align:left!important;min-height:38px;box-sizing:border-box;width:100%!important}
      .communication-card input,.communication-card select,.communication-card textarea,.signup-card input,.signup-card select,.signup-card textarea{font-size:13px!important;letter-spacing:0!important;text-align:left!important}
